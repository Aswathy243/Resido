...
const features = [
  { id: "1", name: "Visitor Log", icon: "clipboard", navigateTo: "visec" },
  { id: "2", name: "attendence", icon: "calendar", navigateTo: "StaffAttendanceCalendar.js" },
];

const HomeScreen = () => {
  const navigation = useNavigation();
  const route = useRoute();
  const { staffId } = route.params || {}; // Retrieve params from login
        ...
        renderItem={({ item }) => (
          <View style={styles.featureWrapper}>
            <TouchableOpacity 
              ...
              onPress={() => {
                if (item.navigateTo === "visec") {
                  navigation.navigate("visec");
                } else if (item.navigateTo === "StaffAttendanceCalendar.js") {
                  navigation.navigate("StaffAttendanceCalendar", { 
                    staffId,
                  });
                } else {
